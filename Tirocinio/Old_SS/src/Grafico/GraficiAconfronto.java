...
import Segnali.Pr;
	...
	public class GraficiAconfronto extends Grafico {
...
//Genera un grafico che confronta due curve. Una relativa al metodo implementato nel caso della simulazione, una relativa al power Detector.
//Entrambi con incertezza pari ad 1DB
		public  GraficiAconfronto (String titolo, ArrayList<ArrayList<Double> > POTENZA1,  ArrayList<ArrayList<Double> > POTENZA2,ArrayList<Pr> prSegnale, ArrayList<Pr>  prRumore) throws Exception {
			...
			setContentPane(chartPanel);
				...
				ChartUtilities.saveChartAsPNG(new File("C:\\Grafico3.png"), chart, 650, 450);
		...
		protected XYDataset createDataset() throws Exception {
			...
			final XYSeries serie1 = generaSerie("Power Detection con incertezza");
			final XYSeries serie2 = generaSerie("Metodo implementato con incertezza");
	...
	protected XYSeries generaSerie(String label) throws Exception {
			...
			XYSeries serie = new XYSeries(label);
		        ...
		        if(label=="Power Detection con incertezza"){
		        ...
		        else if (label=="Metodo implementato con incertezza"){ {
